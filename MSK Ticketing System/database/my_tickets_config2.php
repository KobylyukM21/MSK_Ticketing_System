<?php
        ...
        // Prepare the SQL statement to retrieve the tickets for the logged in user with status open
        $sql = "SELECT * FROM tickets WHERE username='$username' AND status='closed'";
